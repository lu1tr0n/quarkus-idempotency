...
<dependency>
    ...
    <artifactId>quarkus-idempotency</artifactId>
    <version>${quarkus-idempotency.version}</version>
</dependency>
```
...
[documentation](https://docs.quarkiverse.io/quarkus-idempotency/dev/) for the full reference and the
security model.
