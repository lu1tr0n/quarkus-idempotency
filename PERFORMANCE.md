# quarkus-idempotency — Performance
...
with the harness in `quarkus-idempotency-lab/benchmarks/`.
...
## Reproduce
```bash
cd ../quarkus-idempotency && mvn -o install -DskipTests          # publish the extension
cd ../quarkus-idempotency-lab
